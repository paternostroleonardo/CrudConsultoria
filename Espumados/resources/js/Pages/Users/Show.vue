    ...
    <div class="flex items-center justify-center min-h-screen bg-gray-100">
      <div class="flex flex-col items-center w-full max-w-xs p-4 bg-white rounded-3xl md:flex-row">
        ...
        <div class="flex flex-col items-center md:items-start">
            <h2 class="text-xl font-medium">{{ user.name }} {{ user.lastname }}</h2>
            <p class="text-base font-medium text-gray-400">{{ user.rol }}</p>
             <p class="text-base font-medium text-gray-400">{{ user.email }}</p>
             <p class="text-base font-medium text-gray-400">{{ user.phone }}</p>
        </div>
